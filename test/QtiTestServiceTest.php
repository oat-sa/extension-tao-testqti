...
class QtiTestServiceTestCase extends TaoPhpUnitTestRunner {
    ...
    public function testCreateContent() {
        ...
        $this->assertEquals($file->getAbsolutePath(), $contentPath, "The test content property should refer to the file.");
        $this->assertTrue(file_exists($contentPath), "The test content file should exist.");
        
        
        $this->assertEquals(file_get_contents($file->getAbsolutePath()), file_get_contents($contentPath), "The file content match the template file");
    }
}
