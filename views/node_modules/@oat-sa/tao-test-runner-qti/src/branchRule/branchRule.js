...
import branchRuleHelper from 'taoQtiTest/runner/branchRule/helpers/branchRuleHelper';
import branchRuleMapper from 'taoQtiTest/runner/branchRule/branchRuleMapper';
 ...
 */
export default function branchRuleFactory(branchRuleDefinition, item, navigationParams, responseStore) {
    return new Promise(function(resolve) {
        ...
        branchRuleHelper
            .evaluateSubBranchRules(branchRuleDefinition, item, navigationParams, branchRuleMapper, responseStore)
