...
import inlineMessage from 'taoQtiTest/runner/plugins/content/dialog/itemInlineMessage';
import alertMessage from 'taoQtiTest/runner/plugins/content/dialog/itemAlertMessage';
        ...
        var createMessages = function createMessages(renderingQueue, inline) {
            ...
            if (renderingQueue.length) {
                ...
                if (inlineMode && renderedFeedbacks) {
                    autoscroll(
                        $('.qti-modalFeedback', testRunner.getAreaBroker().getContentArea()).first(),
                        testRunner
                            .getAreaBroker()
                            .getContentArea()
