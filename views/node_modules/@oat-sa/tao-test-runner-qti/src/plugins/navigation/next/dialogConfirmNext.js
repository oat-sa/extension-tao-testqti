...
import checkboxTpl from 'taoQtiTest/runner/plugins/navigation/next/tpl/checkbox';
 ...
 */
export default function dialogConfirmNext(heading, message, accept, refuse, checkboxParams, dialogOptions) {
    var accepted = false;
    var dlg;
    var content = null;
