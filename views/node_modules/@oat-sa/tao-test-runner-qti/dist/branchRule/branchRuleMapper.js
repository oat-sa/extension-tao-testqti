define(['taoQtiTest/runner/branchRule/types/match', 'taoQtiTest/runner/branchRule/types/or', 'taoQtiTest/runner/branchRule/types/and', 'taoQtiTest/runner/branchRule/types/not'], function (matchBranchRule, orBranchRule, andBranchRule, notBranchRule) { 'use strict';
    ...
    matchBranchRule = matchBranchRule && matchBranchRule.hasOwnProperty('default') ? matchBranchRule['default'] : matchBranchRule;
    orBranchRule = orBranchRule && orBranchRule.hasOwnProperty('default') ? orBranchRule['default'] : orBranchRule;
    andBranchRule = andBranchRule && andBranchRule.hasOwnProperty('default') ? andBranchRule['default'] : andBranchRule;
    notBranchRule = notBranchRule && notBranchRule.hasOwnProperty('default') ? notBranchRule['default'] : notBranchRule;
