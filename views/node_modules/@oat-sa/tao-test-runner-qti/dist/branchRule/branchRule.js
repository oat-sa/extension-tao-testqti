define(['taoQtiTest/runner/branchRule/helpers/branchRuleHelper', 'taoQtiTest/runner/branchRule/branchRuleMapper'], function (branchRuleHelper, branchRuleMapper) { 'use strict';
    ...
    branchRuleHelper = branchRuleHelper && branchRuleHelper.hasOwnProperty('default') ? branchRuleHelper['default'] : branchRuleHelper;
    branchRuleMapper = branchRuleMapper && branchRuleMapper.hasOwnProperty('default') ? branchRuleMapper['default'] : branchRuleMapper;
