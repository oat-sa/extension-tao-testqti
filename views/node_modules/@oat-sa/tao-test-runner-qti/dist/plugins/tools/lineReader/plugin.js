define(['lodash', 'i18n', 'taoTests/runner/plugin', 'ui/hider', 'util/shortcut', 'util/namespace', 'taoQtiTest/runner/plugins/tools/lineReader/compoundMask'], function (_, __, pluginFactory, hider, shortcut, namespaceHelper, compoundMaskFactory) { 'use strict';
    ...
    compoundMaskFactory = compoundMaskFactory && compoundMaskFactory.hasOwnProperty('default') ? compoundMaskFactory['default'] : compoundMaskFactory;
      ...
      init: function init() {
        ...
        function isEnabled() {
          var context = testRunner.getTestContext() || {},
              options = context.options || {}; //to be activated with the special category x-tao-option-lineReader
