define(['lodash', 'i18n', 'taoTests/runner/plugin', 'ui/hider', 'util/shortcut', 'util/namespace', 'taoQtiTest/runner/plugins/tools/magnifier/magnifierPanel'], function (_, __, pluginFactory, hider, shortcut, namespaceHelper, magnifierPanelFactory) { 'use strict';
    ...
    magnifierPanelFactory = magnifierPanelFactory && magnifierPanelFactory.hasOwnProperty('default') ? magnifierPanelFactory['default'] : magnifierPanelFactory;
      ...
      init: function init() {
        ...
        function isEnabled() {
          var context = testRunner.getTestContext() || {},
              options = context.options || {}; //to be activated with the special category x-tao-option-magnifier
