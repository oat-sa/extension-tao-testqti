define(['jquery', 'lodash', 'i18n', 'core/logger', 'taoTests/runner/plugin', 'util/shortcut', 'util/namespace', 'taoQtiTest/runner/helpers/currentItem', 'taoQtiTest/runner/plugins/tools/highlighter/collection'], function ($, _, __, loggerFactory, pluginFactory, shortcut, namespaceHelper, itemHelper, highlighterCollection) { 'use strict';
    ...
    itemHelper = itemHelper && itemHelper.hasOwnProperty('default') ? itemHelper['default'] : itemHelper;
    highlighterCollection = highlighterCollection && highlighterCollection.hasOwnProperty('default') ? highlighterCollection['default'] : highlighterCollection;
      ...
      init: function init() {
        ...
        function isPluginEnabled() {
          var context = testRunner.getTestContext() || {},
              options = context.options || {}; //to be activated with the special category x-tao-option-highlighter
        ...
        return getStore().then(function (highlighterStore) {
          ...
          testRunner.on('loaditem', togglePlugin).on('enabletools renderitem', function () {
            ...
            if (isPluginEnabled()) {
              _.forEach(highlighters.getAllHighlighters(), function (instance) {
                if (instance.isEnabled()) {
                  instance.off('end.save').toggleHighlighting(false).disable();
                }
              });
            }
          });
