define(['lodash', 'i18n', 'ui/hider', 'util/shortcut', 'util/namespace', 'taoTests/runner/plugin'], function (_, __, hider, shortcut, namespaceHelper, pluginFactory) { 'use strict';
    ...
    var eliminator = pluginFactory({
      ...
      init: function init() {
        ...
        var config = _.defaults(_.clone((testConfig.plugins || {})[pluginName]) || {}, defaultConfig); // register the button in the toolbox
        ...
        function isPluginEnabled() {
          var context = testRunner.getTestContext() || {},
              options = context.options || {}; //to be activated with the special category x-tao-option-eliminator
