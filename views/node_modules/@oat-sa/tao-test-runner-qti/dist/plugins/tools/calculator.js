define(['jquery', 'lodash', 'i18n', 'ui/hider', 'ui/calculator', 'ui/maths/calculator/basicCalculator', 'ui/maths/calculator/scientificCalculator', 'util/shortcut', 'util/namespace', 'taoTests/runner/plugin'], function ($, _, __, hider, calculatorFactory, basicCalculatorFactory, scientificCalculatorFactory, shortcut, namespaceHelper, pluginFactory) { 'use strict';
    ...
    calculatorFactory = calculatorFactory && calculatorFactory.hasOwnProperty('default') ? calculatorFactory['default'] : calculatorFactory;
    basicCalculatorFactory = basicCalculatorFactory && basicCalculatorFactory.hasOwnProperty('default') ? basicCalculatorFactory['default'] : basicCalculatorFactory;
    scientificCalculatorFactory = scientificCalculatorFactory && scientificCalculatorFactory.hasOwnProperty('default') ? scientificCalculatorFactory['default'] : scientificCalculatorFactory;
      ...
      init: function init() {
        ...
        function isEnabled() {
          var context = testRunner.getTestContext() || {},
              options = context.options || {}; //to be activated with a special category from:
        ...
        this.$calculatorContainer = $('<div class="widget-calculator">'); //init calculator instance var, it will be created only necessary
