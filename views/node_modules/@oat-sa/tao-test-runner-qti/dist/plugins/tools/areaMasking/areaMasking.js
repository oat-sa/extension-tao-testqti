define(['lodash', 'i18n', 'ui/hider', 'util/shortcut', 'util/namespace', 'taoTests/runner/plugin', 'taoQtiTest/runner/plugins/tools/areaMasking/mask'], function (_, __, hider, shortcut, namespaceHelper, pluginFactory, maskComponent) { 'use strict';
    ...
    maskComponent = maskComponent && maskComponent.hasOwnProperty('default') ? maskComponent['default'] : maskComponent;
      ...
      init: function init() {
        ...
        function isEnabled() {
          var context = testRunner.getTestContext(),
              options = context.options || {}; //to be activated with the special category x-tao-option-areaMasking
