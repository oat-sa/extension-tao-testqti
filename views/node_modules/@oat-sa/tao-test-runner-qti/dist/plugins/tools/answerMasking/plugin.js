define(['lodash', 'i18n', 'taoTests/runner/plugin', 'ui/hider', 'util/shortcut', 'util/namespace', 'taoQtiTest/runner/plugins/tools/answerMasking/answerMasking'], function (_, __, pluginFactory, hider, shortcut, namespaceHelper, answerMaskingFactory) { 'use strict';
    ...
    answerMaskingFactory = answerMaskingFactory && answerMaskingFactory.hasOwnProperty('default') ? answerMaskingFactory['default'] : answerMaskingFactory;
      ...
      init: function init() {
        ...
        function isPluginEnabled() {
          var context = testRunner.getTestContext() || {},
              options = context.options || {}; //to be activated with the special category x-tao-option-answerMasking
