define(['i18n', 'taoTests/runner/plugin', 'taoQtiTest/runner/helpers/map', 'taoQtiTest/runner/helpers/currentItem', 'taoQtiTest/runner/plugins/navigation/next/dialogConfirmNext'], function (__, pluginFactory, mapHelper, currentItemHelper, dialogConfirmNext) { 'use strict';
    ...
    dialogConfirmNext = dialogConfirmNext && dialogConfirmNext.hasOwnProperty('default') ? dialogConfirmNext['default'] : dialogConfirmNext;
