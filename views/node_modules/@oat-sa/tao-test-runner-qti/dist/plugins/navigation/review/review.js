define(['lodash', 'i18n', 'ui/hider', 'util/shortcut', 'util/namespace', 'taoTests/runner/plugin', 'taoQtiTest/runner/helpers/map', 'taoQtiTest/runner/plugins/navigation/review/navigator'], function (_, __, hider, shortcut, namespaceHelper, pluginFactory, mapHelper, navigatorFactory) { 'use strict';
    ...
    navigatorFactory = navigatorFactory && navigatorFactory.hasOwnProperty('default') ? navigatorFactory['default'] : navigatorFactory;
      ...
      init: function init() {
        ...
        function flagItem(position, flag) {
          ...
          return testRunner.getProxy().callTestAction('flagItem', {
            ...
            var context = testRunner.getTestContext(); // update the state in the context if the flagged item is the current one
            ...
            updateButton(self.flagItemButton, getFlagItemButtonData(context)); // update the item state
        ...
        this.navigator = navigatorFactory(navigatorConfig, testMap, testContext).on('selected', function (position, previousPosition) {
        ...
        this.disable();
        togglePanel(testConfig.review.defaultOpen); //change plugin state
