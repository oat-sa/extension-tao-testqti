define(['lodash', 'core/polling', 'core/timer', 'taoTests/runner/plugin'], function (_, pollingFactory, timerFactory, pluginFactory) { 'use strict';
    ...
    var duration = pluginFactory({
      ...
      init: function init() {
        var self = this;
        var testRunner = this.getTestRunner(); //where the duration of attempts are stored
