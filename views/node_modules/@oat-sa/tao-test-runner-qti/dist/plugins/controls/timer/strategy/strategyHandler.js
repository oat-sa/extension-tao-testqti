define(['lodash', 'taoQtiTest/runner/plugins/controls/timer/strategy/enforcedStay', 'taoQtiTest/runner/plugins/controls/timer/strategy/extraTime', 'taoQtiTest/runner/plugins/controls/timer/strategy/guidedNavigation', 'taoQtiTest/runner/plugins/controls/timer/strategy/timeout', 'taoQtiTest/runner/plugins/controls/timer/strategy/warnSectionLeaving'], function (_, extraTimeStrategy, enforcedStayStrategy, guidedNavigationStrategy, timeoutStrategy, warnSectionLeavingStrategy) { 'use strict';
    ...
    extraTimeStrategy = extraTimeStrategy && extraTimeStrategy.hasOwnProperty('default') ? extraTimeStrategy['default'] : extraTimeStrategy;
    enforcedStayStrategy = enforcedStayStrategy && enforcedStayStrategy.hasOwnProperty('default') ? enforcedStayStrategy['default'] : enforcedStayStrategy;
    guidedNavigationStrategy = guidedNavigationStrategy && guidedNavigationStrategy.hasOwnProperty('default') ? guidedNavigationStrategy['default'] : guidedNavigationStrategy;
    timeoutStrategy = timeoutStrategy && timeoutStrategy.hasOwnProperty('default') ? timeoutStrategy['default'] : timeoutStrategy;
    warnSectionLeavingStrategy = warnSectionLeavingStrategy && warnSectionLeavingStrategy.hasOwnProperty('default') ? warnSectionLeavingStrategy['default'] : warnSectionLeavingStrategy;
