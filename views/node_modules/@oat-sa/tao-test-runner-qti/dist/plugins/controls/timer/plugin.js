define(['lodash', 'taoTests/runner/plugin', 'taoQtiTest/runner/plugins/controls/timer/strategy/strategyHandler', 'taoQtiTest/runner/plugins/controls/timer/component/timerbox', 'taoQtiTest/runner/plugins/controls/timer/timers'], function (_, pluginFactory, getStrategyHandler, timerboxFactory, timersFactory) { 'use strict';

    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;
    pluginFactory = pluginFactory && pluginFactory.hasOwnProperty('default') ? pluginFactory['default'] : pluginFactory;
    getStrategyHandler = getStrategyHandler && getStrategyHandler.hasOwnProperty('default') ? getStrategyHandler['default'] : getStrategyHandler;
    timerboxFactory = timerboxFactory && timerboxFactory.hasOwnProperty('default') ? timerboxFactory['default'] : timerboxFactory;
    timersFactory = timersFactory && timersFactory.hasOwnProperty('default') ? timersFactory['default'] : timersFactory;
      ...
      init: function init() {
        ...
        return new Promise(function (resolve) {
          ...
          return testRunner.getPluginStore(self.getName()).then(function (timeStore) {
            testRunner.before('renderitem resumeitem', function () {
