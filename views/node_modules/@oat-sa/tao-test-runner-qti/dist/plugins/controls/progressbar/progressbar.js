define(['lodash', 'taoTests/runner/plugin', 'taoQtiTest/runner/helpers/map', 'taoQtiTest/runner/plugins/controls/progressbar/progress', 'taoQtiTest/runner/plugins/controls/progressbar/renderer/percentage', 'taoQtiTest/runner/plugins/controls/progressbar/renderer/position'], function (_, pluginFactory, mapHelper, progressHelper, percentageRendererFactory, positionRendererFactory) { 'use strict';
    ...
    progressHelper = progressHelper && progressHelper.hasOwnProperty('default') ? progressHelper['default'] : progressHelper;
    percentageRendererFactory = percentageRendererFactory && percentageRendererFactory.hasOwnProperty('default') ? percentageRendererFactory['default'] : percentageRendererFactory;
    positionRendererFactory = positionRendererFactory && positionRendererFactory.hasOwnProperty('default') ? positionRendererFactory['default'] : positionRendererFactory;
