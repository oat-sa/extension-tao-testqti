define(['lodash', 'jquery', 'ui/component', 'taoQtiTest/runner/ui/toolbox/entry', 'taoQtiTest/runner/ui/toolbox/menu', 'taoQtiTest/runner/ui/toolbox/text', 'handlebars'], function (_, $$1, componentFactory, entryFactory, menuFactory, textFactory, Handlebars) { 'use strict';
    ...
    entryFactory = entryFactory && entryFactory.hasOwnProperty('default') ? entryFactory['default'] : entryFactory;
    menuFactory = menuFactory && menuFactory.hasOwnProperty('default') ? menuFactory['default'] : menuFactory;
    textFactory = textFactory && textFactory.hasOwnProperty('default') ? textFactory['default'] : textFactory;
