define(['lodash', 'taoQtiTest/runner/helpers/map', 'taoQtiTest/runner/helpers/testContextBuilder'], function (_, mapHelper, testContextBuilder) { 'use strict';
    ...
    testContextBuilder = testContextBuilder && testContextBuilder.hasOwnProperty('default') ? testContextBuilder['default'] : testContextBuilder;
    ...
    var navigatorFactory = function navigatorFactory(testData, testContext, testMap) {
      ...
      return {
        ...
        nextItem: function nextItem() {
          return testContextBuilder.buildTestContextFromPosition(testData, testContext, testMap, testContext.itemPosition + 1);
        },
        ...
        nextSection: function nextSection() {
          ...
          return testContextBuilder.buildTestContextFromPosition(testData, testContext, testMap, section.position + sectionStats.total);
        },
