define(['i18n', 'taoQtiTest/runner/helpers/stats'], function (__, statsHelper) { 'use strict';
    ...
    function getExitMessage(message, scope, runner, sync) {
      ...
      return "".concat(itemsCountMessage, " ").concat(message).trim();
    }
    /**
    ...
    function getUnansweredItemsWarning(scope, runner, sync) {
      ...
      if (scope === 'section' || scope === 'testSection') {
        if (unansweredCount === 0) {
          ...
          itemsCountMessage = __('You answered only %s of the %s question(s) in this section', stats.answered.toString(), stats.questions.toString());
        }
