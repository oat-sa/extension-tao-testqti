define(['lodash', 'taoQtiTest/runner/navigator/offlineNavigator', 'taoQtiTest/runner/helpers/navigation', 'taoQtiTest/runner/provider/dataUpdater', 'taoQtiTest/runner/proxy/qtiServiceProxy', 'taoQtiTest/runner/proxy/cache/itemStore', 'taoQtiTest/runner/proxy/cache/actionStore', 'taoQtiTest/runner/helpers/offlineErrorHelper', 'taoQtiTest/runner/helpers/offlineSyncModal', 'taoQtiTest/runner/services/responseStore', 'util/download'], function (_, offlineNavigatorFactory, navigationHelper, dataUpdater, qtiServiceProxy, itemStoreFactory, actionStoreFactory, offlineErrorHelper, offlineSyncModal, responseStoreFactory, download) { 'use strict';
    ...
    offlineNavigatorFactory = offlineNavigatorFactory && offlineNavigatorFactory.hasOwnProperty('default') ? offlineNavigatorFactory['default'] : offlineNavigatorFactory;
    ...
    offlineSyncModal = offlineSyncModal && offlineSyncModal.hasOwnProperty('default') ? offlineSyncModal['default'] : offlineSyncModal;
    responseStoreFactory = responseStoreFactory && responseStoreFactory.hasOwnProperty('default') ? responseStoreFactory['default'] : responseStoreFactory;
    download = download && download.hasOwnProperty('default') ? download['default'] : download;
    ...
    var proxy = _.defaults({
      ...
      install: function install(config) {
        ...
        this.offlineAction = function offlineAction(action, actionParams) {
          return new Promise(function (resolve, reject) {
            ...
            var navigate = function navigate(navigator, options, results) {
              var newTestContext;
              navigator.setTestData(options.testData).setTestContext(options.testContext).setTestMap(options.testMap).init().navigate(actionParams.direction, actionParams.scope, actionParams.ref, actionParams).then(function (res) {
                newTestContext = res;
        ...
        this.prepareDownload = function prepareDownload(actions) {
          ...
          var niceFilename = "Download of ".concat(testId, " at ").concat(dateTime, ".json");
          return {
