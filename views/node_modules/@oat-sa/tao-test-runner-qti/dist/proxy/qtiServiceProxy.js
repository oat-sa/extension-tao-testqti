define(['lodash', 'core/promiseQueue', 'core/communicator', 'taoQtiTest/runner/config/qtiServiceConfig', 'core/request'], function (_, promiseQueue, communicatorFactory, configFactory, coreRequest) { 'use strict';
    ...
    communicatorFactory = communicatorFactory && communicatorFactory.hasOwnProperty('default') ? communicatorFactory['default'] : communicatorFactory;
    configFactory = configFactory && configFactory.hasOwnProperty('default') ? configFactory['default'] : configFactory;
