define(['lodash', 'core/logger', 'taoQtiItem/runner/qtiItemRunner', 'taoQtiTest/runner/config/assetManager', 'util/url'], function (_, loggerFactory, qtiItemRunner, getAssetManager, urlUtil) { 'use strict';
    ...
    var itemPreloaderFactory = function itemPreloaderFactory(options) {
      ...
      var testAssetManager; //we also have a specific instance of the asset manager to
      //resolve assets of a next item (we can't use the test asset manager).

      var preloadAssetManager = getAssetManager('item-preloader'); //keep references to preloaded images attached
      //in order to prevent garbage collection of cached images

      var images = {}; //keep references to preloaded audio blobs
      ...
      var unloaders = {
        ...
        css: function unloadCss(url) {
          var link = document.querySelector("head link[data-preload][href=\"".concat(url, "\"]"));
      ...
      testAssetManager.prependStrategy({
        ...
        handle: function handlePrecache(url, data) {
          ...
          if (data.itemIdentifier && audioBlobs[data.itemIdentifier] && typeof audioBlobs[data.itemIdentifier][sourceUrl] !== 'undefined') {
