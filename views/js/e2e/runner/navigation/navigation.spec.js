...
describe('Navigation', () => {
    ...
    describe('Linear Test Navigation', () => {
        ...
        before(() => {
            ...
            cy.addRoutes();
            cy.login('admin');
            cy.importTestPackage(base64LinearTest);
    ...
    describe('Non Linear Test Navigation', () => {
        ...
        before(() => {
            ...
            cy.addTestRoutes();
            cy.login('admin');
            cy.importTestPackage(base64NonLinearTest);
            cy.publishTest('e2e navigation non linear test');
            cy.setDeliveryForGuests('Delivery of e2e navigation non linear test');
            cy.logout();
        });
        ...
        beforeEach(() => {
            ...
            cy.addTestRoutes();
            cy.guestLogin();
            cy.startTest('Delivery of e2e navigation non linear test');
        });
        ...
        after(() => {
            ...
            cy.deleteDelivery('Delivery of e2e navigation non linear test');
        });
