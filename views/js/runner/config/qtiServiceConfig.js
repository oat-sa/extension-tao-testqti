define(['lodash', 'util/url', 'util/config'], function (_, urlUtil, configHelper) { 'use strict';
    ...
    function configFactory(config) {
      ...
      var undef; // convert some values from seconds to milliseconds
      ...
      return {
        ...
        getCommunicationConfig: function getCommunicationConfig() {
          ...
          var syncActions = communication.syncActions || []; // build the service address from the provided config
