...
"use strict";return pluginFactory({name:"connectivity",init:function(){},install:function(){function disconnect(){testRunner.getState("disconnected")||testRunner.trigger("disconnect")}function reconnect(){testRunner.getState("disconnected")&&testRunner.trigger("reconnect")}var testRunner=this.getTestRunner();$(window).on("offline.connectivity",function(){disconnect()}),$(window).on("online.connectivity",function(){reconnect()}),testRunner.on("disconnect",function(){testRunner.setState("disconnected",!0)}).on("reconnect",function(){testRunner.setState("disconnected",!1)}).before("error",function(e,error){if(_.isObject(error)&&"network"===error.source&&"undefined"==typeof error.code)return disconnect(),
