...
define( [
    ...
    QUnit.test( 'handle menu entries and orphan menu entries', function( assert ) {
        ...
        assert.equal( $result.eq( 0 ).data( 'control' ), 'entry3', 'entry3 has been rendered in 1st position of menu "menu1"' );
        assert.equal( $result.eq( 1 ).data( 'control' ), 'entry7', 'entry4 has been rendered in 2nd position of menu "menu1"' );
        assert.equal( $result.eq( 2 ).data( 'control' ), 'entry10', 'entry10 has been rendered in 3rd position of menu "menu1"' );
        ...
        assert.equal( $result.eq( 0 ).data( 'control' ), 'entry6', 'entry6 has been rendered in 1st position of menu "menu2"' );
        assert.equal( $result.eq( 1 ).data( 'control' ), 'entry9', 'entry9 has been rendered in 2nd position of menu "menu2"' );
