 ...
 */
define(['taoQtiTest/runner/helpers/config'], function(configHelper) {
    'use strict';
    ...
    QUnit.cases([
        ...
        QUnit.expect(1);
        assert.equal(typeof configHelper[data.title], 'function', 'The config helper expose a "' + data.title + '" function');
    });
