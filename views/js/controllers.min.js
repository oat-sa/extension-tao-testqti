...
},afterTransition:function(){this.enableGui(),iframeNotifier.parent("unloading")},jump:function(position){var self=this;this.disableGui(),this.itemServiceApi.kill(function(){self.actionCall("jump",null,{position:position})})},markForReview:function(flag,position){var self=this;this.disableGui(),this.itemServiceApi.kill(function(){$.ajax({url:self.testContext.markForReviewUrl,cache:!1,async:!0,type:"POST",dataType:"json",data:{flag:flag,position:position},success:function(testContext){self.setTestContext(testContext),self.updateTestReview(),self.enableGui()}})})},moveForward:function(){var self=this;this.disableGui(),this.itemServiceApi.kill(function(){var metaData,lastInSection=self.testContext.itemPositionSection+1===self.testContext.numberItemsSection;
lastInSection&&(metaData={SECTION:{SECTION_EXIT_CODE:TestRunner.SECTION_EXIT_CODE.COMPLETED_NORMALLY}}),self.actionCall("moveForward",metaData)})},moveBackward:function(){var self=this;this.disableGui(),this.itemServiceApi.kill(function(){self.actionCall("moveBackward")})},skip:function(){this.disableGui(),this.actionCall("skip")},timeout:function(){var self=this;this.disableGui(),this.testContext.isTimeout=!0,this.updateTimer(),this.itemServiceApi.kill(function(){var confirmBox=$(".timeout-modal-feedback"),testContext=self.testContext,confirmBtn=confirmBox.find(".js-timeout-confirm, .modal-close"),metaData={};metaData=testContext.numberCompletedSection===testContext.numberItemsSection?{SECTION:{SECTION_EXIT_CODE:TestRunner.SECTION_EXIT_CODE.COMPLETE_TIMEOUT}}:{SECTION:{SECTION_EXIT_CODE:TestRunner.SECTION_EXIT_CODE.TIMEOUT}},confirmBox.modal({width:500}),confirmBtn.off("click").on("click",function(){confirmBox.modal("close"),self.actionCall("timeout",metaData)
