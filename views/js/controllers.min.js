...
options={hash:{},data:data},helper?helper.call(depth0,"This constraint affects the visibility of feedback after the end of the last attempt.",options):helperMissing.call(depth0,"__","This constraint affects the visibility of feedback after the end of the last attempt.",options)))+'\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n\r\n\r\n\r\n\r\n<!-- assessmentTest/testPart/assessmentSection/itemSessionControl/allowComment -->\r\n        <div class="grid-row pseudo-label-box">\r\n            <div class="col-5">\r\n                <label for="section-allow-comment">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},
data:data},helper?helper.call(depth0,"Allow Comment",options):helperMissing.call(depth0,"__","Allow Comment",options)))+'</label>\r\n            </div>\r\n            <div class="col-6">\r\n                <label>\r\n                    <input type="checkbox" name="section-allow-comment" value="true"  data-bind="itemSessionControl.allowComment" data-bind-encoder="boolean" />\r\n                    <span class="icon-checkbox"></span>\r\n                </label>\r\n            </div>\r\n            <div class="col-1 help">\r\n                <span class="icon-help" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\r\n                <div class="tooltip-content">\r\n                '+escapeExpression((helper=helpers.__||depth0&&depth0.__,
...
options={hash:{},data:data},helper?helper.call(depth0,"This constraint affects the visibility of feedback after the end of the last attempt.",options):helperMissing.call(depth0,"__","This constraint affects the visibility of feedback after the end of the last attempt.",options)))+'\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n\r\n\r\n\r\n\r\n<!-- assessmentTest/testPart/assessmentSection/sectionPart/itemSessionControl/allowComment -->\r\n        <div class="grid-row pseudo-label-box">\r\n            <div class="col-5">\r\n                <label for="itemref-allow-comment">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={
...
options={hash:{},data:data},helper?helper.call(depth0,"Maximum Duration",options):helperMissing.call(depth0,"__","Maximum Duration",options)))+'</label>\r\n                </div>\r\n                <div class="col-6">\r\n                    <input type="text" name="max-time" value="00:00:00" data-duration="HH:mm:ss" data-bind="timeLimits.maxTime" data-bind-encoder="time" />\r\n                </div>\r\n                <div class="col-1 help">\r\n                    <span class="icon-help" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\r\n                    <div class="tooltip-content">\r\n                        '+escapeExpression((helper=helpers.__||depth0&&depth0.__,
options={hash:{},data:data},helper?helper.call(depth0,"Minimum duration : enforces the test taker to stay on the item for the given duration.",options):helperMissing.call(depth0,"__","Minimum duration : enforces the test taker to stay on the item for the given duration.",options)))+"<br>\r\n                        "+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Maximum duration : the items times out when the duration reaches 0.",options):helperMissing.call(depth0,"__","Maximum duration : the items times out when the duration reaches 0.",options)))+"<br>\r\n                        "+escapeExpression((helper=helpers.__||depth0&&depth0.__,
options={hash:{},data:data},helper?helper.call(depth0,"Locked duration  : guided navigation. The test transition to the next item once the duration reaches 0.",options):helperMissing.call(depth0,"__","Locked duration  : guided navigation. The test transition to the next item once the duration reaches 0.",options)))+'<br>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class="locker">\r\n                <button class="unlocked" title=\''+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Link durations to activate the guided navigation",options):helperMissing.call(depth0,"__","Link durations to activate the guided navigation",options)))+'\' ><span class="icon-unlink"></span></button>\r\n            </div>\r\n            <div class="grid-row">\r\n                <div class="col-5">\r\n                    <label for="itemref-min-time">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,
options={hash:{},data:data},helper?helper.call(depth0,"Minimum Duration",options):helperMissing.call(depth0,"__","Minimum Duration",options)))+'</label>\r\n                </div>\r\n                <div class="col-6">\r\n                    <input type="text" name="min-time" value="00:00:00" data-duration="HH:mm:ss"  data-bind="timeLimits.minTime" data-bind-encoder="time" />\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n<!-- assessmentTest/testPart/assessmentSection/sectionPart/timeLimits/maxTime -->\r\n        <div class="grid-row maxtime-container ',stack1=helpers.if.call(depth0,depth0&&depth0.isLinear,{hash:{},inverse:self.noop,fn:self.program(1,program1,data),
...
options={hash:{},data:data},helper?helper.call(depth0,"Set the XHTML-QTI class of the rubric block.",options):helperMissing.call(depth0,"__","Set the XHTML-QTI class of the rubric block.",options)))+'\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <!--assessmentTest/testPart/assessmentSection/sectionPart/rubricBlock/id -->\r\n    <!--\r\n    <div class="grid-row">\r\n        <div class="col-5">\r\n            <label for="id">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Identifier",options):helperMissing.call(depth0,"__","Identifier",options)))+'</label>\r\n        </div>\r\n        <div class="col-6">\r\n            <input type="text" name="id" data-bind="id" data-bind-encoder="string" data-validate="$pattern(pattern=^([a-zA-Z_\\s][a-zA-Z0-9_\\s-]*)?$);" />\r\n        </div>\r\n        <div class="col-1 help">\r\n            <span class="icon-help" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\r\n            <div class="tooltip-content">\r\n                '+escapeExpression((helper=helpers.__||depth0&&depth0.__,
options={hash:{},data:data},helper?helper.call(depth0,"Set the XHTML-QTI identifier of the rubric block.",options):helperMissing.call(depth0,"__","Set the XHTML-QTI identifier of the rubric block.",options)))+'\r\n            </div>\r\n        </div>\r\n    </div>\r\n    -->\r\n\r\n    <h4 class="toggler closed" data-toggle="~ .rubric-feedback">'+escapeExpression((helper=helpers.__||depth0&&depth0.__,options={hash:{},data:data},helper?helper.call(depth0,"Feedback block",options):helperMissing.call(depth0,"__","Feedback block",options)))+"</h4>\r\n\r\n    <!--assessmentTest/testPart/assessmentSection/sectionPart/rubricBlock/feedback -->\r\n    ",stack1=helpers.with.call(depth0,depth0&&depth0.feedback,{
hash:{},inverse:self.noop,fn:self.program(1,program1,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),buffer+="\r\n</div>"})}),define("tpl!taoQtiTest/controller/creator/templates/category-presets",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){function program1(depth0,data){var stack1,helper,buffer="";return buffer+='\r\n\r\n<h4 class="toggler closed" data-toggle="~ .category-preset-group-',(helper=helpers.groupId)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.groupId,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'">',
(helper=helpers.groupLabel)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.groupLabel,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'</h4>\r\n\r\n<div class="category-preset-group-',(helper=helpers.groupId)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.groupId,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+' toggled">\r\n    ',stack1=helpers.each.call(depth0,depth0&&depth0.presets,{hash:{},inverse:self.noop,fn:self.program(2,program2,data),data:data}),(stack1||0===stack1)&&(buffer+=stack1),
buffer+="\r\n</div>\r\n\r\n"}function program2(depth0,data){var stack1,helper,buffer="";return buffer+='\r\n    <div class="grid-row pseudo-label-box category-preset" data-qti-category="',(helper=helpers.qtiCategory)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.qtiCategory,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'">\r\n        <div class="col-1">\r\n            <label>\r\n                <input type="checkbox" name="category-preset-',(helper=helpers.id)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.id,stack1=typeof helper===functionType?helper.call(depth0,{
hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'" value="',(helper=helpers.qtiCategory)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.qtiCategory,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'"/>\r\n                <span class="icon-checkbox"></span>\r\n            </label>\r\n        </div>\r\n        <div class="col-10">\r\n            <label for="category-preset-',(helper=helpers.id)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.id,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'">',
(helper=helpers.label)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.label,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+'</label>\r\n        </div>\r\n        <div class="col-1 help">\r\n            <span class="icon-help" data-tooltip="~ .tooltip-content" data-tooltip-theme="info"></span>\r\n            <div class="tooltip-content">\r\n                ',(helper=helpers.description)?stack1=helper.call(depth0,{hash:{},data:data}):(helper=depth0&&depth0.description,stack1=typeof helper===functionType?helper.call(depth0,{hash:{},data:data}):helper),buffer+=escapeExpression(stack1)+"\r\n            </div>\r\n        </div>\r\n    </div>\r\n    ";
...
$maxTimeField.off("change.sync"),$maxTimeField.val($minTimeField.val()).trigger("change"),_.defer(function(){$maxTimeField.on("change.sync",minToMaxHandler)})},200),maxToMinHandler=_.throttle(function(){$minTimeField.off("change.sync"),$minTimeField.val($maxTimeField.val()).trigger("change"),_.defer(function(){$minTimeField.on("change.sync",minToMaxHandler)})},200),lockTimers=function(){$locker.removeClass("unlocked").addClass("locked").attr("title",__("Unlink to use separated durations")),$minTimeField.val($maxTimeField.val()).trigger("change"),$minTimeField.on("change.sync",minToMaxHandler),$maxTimeField.on("change.sync",maxToMinHandler)},unlockTimers=function(){
$locker.removeClass("locked").addClass("unlocked").attr("title",__("Link durations to activate the guided navigation")),$durationFields.off("change.sync"),$minTimeField.val("00:00:00").trigger("change")},toggleTimeContainers=function(){refModel.isLinear=0===partModel.navigationMode,refModel.isLinear&&config.guidedNavigation?($minTimeContainer.addClass("hidden"),$maxTimeContainer.addClass("hidden"),$lockedTimeContainer.removeClass("hidden"),$minTimeField.val()===$maxTimeField.val()&&"00:00:00"!==$maxTimeField.val()&&lockTimers(),$locker.on("click",function(e){e.preventDefault(),$locker.hasClass("locked")?unlockTimers():lockTimers()})):refModel.isLinear?($lockedTimeContainer.addClass("hidden"),
$minTimeContainer.removeClass("hidden"),$maxTimeContainer.removeClass("hidden")):($lockedTimeContainer.addClass("hidden"),$minTimeContainer.addClass("hidden"),$maxTimeContainer.removeClass("hidden"))};modelOverseer.on("testpart-change",function(){toggleTimeContainers()}),toggleTimeContainers(),$durationFields.on("change.check",function(){refModel.timeLimits.minTime>0&&refModel.timeLimits.maxTime>0&&refModel.timeLimits.minTime>refModel.timeLimits.maxTime?$minTimeField.parent("div").find(".duration-ctrl-wrapper").addClass("brd-danger"):$minTimeField.parent("div").find(".duration-ctrl-wrapper").removeClass("brd-danger")})}function categoriesProperty($view){var categorySelector=categorySelectorFactory($view),$categoryField=$view.find('[name="itemref-category"]');
categorySelector.createForm(),categorySelector.updateFormState(refModel.categories),$view.on("propopen.propview",function(){categorySelector.updateFormState(refModel.categories)}),categorySelector.on("category-change",function(selected){$categoryField.val(selected.join(",")),$categoryField.trigger("change"),modelOverseer.trigger("category-change",selected)})}function weightsProperty(propView){var $view=propView.getView(),$weightList=$view.find('[data-bind-each="weights"]'),weightTpl=templates.properties.itemrefweight;$view.find(".itemref-weight-add").on("click",function(e){var defaultData={value:1,"qti-type":"weight",identifier:0===refModel.weights.length?"WEIGHT":qtiTestHelper.getAvailableIdentifier(refModel,"weight","WEIGHT")
};e.preventDefault(),$weightList.append(weightTpl(defaultData)),refModel.weights.push(defaultData),$weightList.trigger("add.internalbinder"),$view.groupValidator()})}function propHandler(propView){var removePropHandler=function(){null!==propView&&propView.destroy()};categoriesProperty(propView.getView()),weightsProperty(propView),timeLimitsProperty(propView),$itemRef.parents(".testpart").on("delete",removePropHandler),$itemRef.parents(".section").on("delete",removePropHandler),$itemRef.on("delete",removePropHandler)}var modelOverseer=creatorContext.getModelOverseer(),config=modelOverseer.getConfig()||{},$actionContainer=$(".actions",$itemRef);refModel.itemSessionControl||(refModel.itemSessionControl={}),
_.defaults(refModel.itemSessionControl,sectionModel.itemSessionControl),refModel.isLinear=0===partModel.navigationMode,actions.properties($actionContainer,"itemref",refModel,propHandler),actions.move($actionContainer,"itemrefs","itemref"),resize()}function listenActionState(){$(".itemrefs").each(function(){actions.movable($(".itemref",$(this)),"itemref",".actions")}),$(document).on("delete",function(e){var $parent,$target=$(e.target);$target.hasClass("itemref")&&($parent=$target.parents(".itemrefs"),actions.disable($parent.find(".itemref"),".actions"))}).on("add change undo.deleter deleted.deleter",".itemrefs",function(e){var $parent,$target=$(e.target);($target.hasClass("itemref")||$target.hasClass("itemrefs"))&&($parent=$(".itemref",$target.hasClass("itemrefs")?$target:$target.parents(".itemrefs")),
actions.enable($parent,".actions"),actions.movable($parent,"itemref",".actions"))})}var resize=_.throttle(function(){var $refs=$(".itemrefs").first(),$actions=$(".itemref .actions").first(),width=$refs.innerWidth()-$actions.outerWidth();$(".itemref > .title").width(width)},100);return{setUp:setUp,listenActionState:listenActionState,resize:resize}}),define("taoQtiTest/controller/creator/encoders/dom2qti",["jquery","lodash","taoQtiTest/controller/creator/helpers/qtiElement","taoQtiTest/controller/creator/helpers/baseType"],function($,_,qtiElementHelper,baseType){"use strict";function getAttributes(object){return _.omit(object,["qti-type","content","xmlBase","lang","label"]);
}function attrToStr(attributes){return _.reduce(attributes,function(acc,value,key){return _.isNumber(value)||_.isBoolean(value)||_.isString(value)&&!_.isEmpty(value)?acc+" "+key+'="'+value+'" ':acc},"")}function normalizeNodeName(nodeName){var normalized=nodeName?nodeName.toLocaleLowerCase():"";return normalizedNodes[normalized]||normalized}var normalizedNodes={feedbackblock:"feedbackBlock",outcomeidentifier:"outcomeIdentifier",showhide:"showHide",printedvariable:"printedVariable",powerform:"powerForm",mappingindicator:"mappingIndicator"},typedAttributes={printedVariable:{identifier:baseType.getConstantByName("identifier"),powerForm:baseType.getConstantByName("boolean"),
base:baseType.getConstantByName("intOrIdentifier"),index:baseType.getConstantByName("intOrIdentifier"),delimiter:baseType.getConstantByName("string"),field:baseType.getConstantByName("string"),mappingIndicator:baseType.getConstantByName("string")}};return{encode:function(modelValue){var startTag,self=this;return _.isArray(modelValue)?_.reduce(modelValue,function(result,value){return result+self.encode(value)},""):_.isObject(modelValue)&&modelValue["qti-type"]?"textRun"===modelValue["qti-type"]?modelValue.content:(startTag="<"+modelValue["qti-type"]+attrToStr(getAttributes(modelValue)),modelValue.content?startTag+">"+self.encode(modelValue.content)+"</"+modelValue["qti-type"]+">":startTag+"/>"):""+modelValue;
...
return"function"==typeof elt.postRender}).map(function(elt){return elt.postRender(data,"",renderer)}).flatten(!0).value().concat(this._super(data,altClassName,renderer));return res},toArray:function(){var arr={serial:this.serial,body:this.bdy,elements:{}};for(var serial in this.elements)arr.elements[serial]=this.elements[serial].toArray();return arr},find:function(serial,parent){var found=null;return this.elements[serial]?found={parent:parent||this,element:this.elements[serial],location:"body"}:_.each(this.elements,function(elt){if(found=elt.find(serial))return!1}),found},isEmpty:function(){return!this.bdy}});return Container}),define("taoQtiItem/qtiCreator/model/Container",["lodash","taoQtiItem/qtiCreator/model/mixin/editable","taoQtiItem/qtiItem/core/Container"],function(_,editable,Container){
"use strict";var methods={};return _.extend(methods,editable),_.extend(methods,{afterCreate:function(){this.body("<p>Lorem ipsum dolor sit amet, consectetur adipisicing ...</p>")},beforeRemove:function(){_.each(this.getComposingElements(),function(element){_.isFunction(element.beforeRemove)&&element.beforeRemove()})}}),Container.extend(methods)}),define("taoQtiItem/qtiCreator/model/qtiClasses",["lodash","taoQtiItem/qtiItem/core/qtiClasses"],function(_,qtiClasses){"use strict";return _.defaults({assessmentItem:"taoQtiItem/qtiCreator/model/Item",_container:"taoQtiItem/qtiCreator/model/Container",img:"taoQtiItem/qtiCreator/model/Img",math:"taoQtiItem/qtiCreator/model/Math",
object:"taoQtiItem/qtiCreator/model/Object",table:"taoQtiItem/qtiCreator/model/Table",rubricBlock:"taoQtiItem/qtiCreator/model/RubricBlock",modalFeedback:"taoQtiItem/qtiCreator/model/feedbacks/ModalFeedback",choiceInteraction:"taoQtiItem/qtiCreator/model/interactions/ChoiceInteraction",orderInteraction:"taoQtiItem/qtiCreator/model/interactions/OrderInteraction",associateInteraction:"taoQtiItem/qtiCreator/model/interactions/AssociateInteraction",matchInteraction:"taoQtiItem/qtiCreator/model/interactions/MatchInteraction",inlineChoiceInteraction:"taoQtiItem/qtiCreator/model/interactions/InlineChoiceInteraction",simpleChoice:"taoQtiItem/qtiCreator/model/choices/SimpleChoice",
...
}});return Container.augment(Item),Item}),define("taoQtiItem/qtiItem/core/Stylesheet",["taoQtiItem/qtiItem/core/Element","lodash","taoQtiItem/qtiItem/helper/rendererConfig"],function(Element,_,rendererConfig){var Stylesheet=Element.extend({qtiClass:"stylesheet",render:function(){var args=rendererConfig.getOptionsFromArguments(arguments),renderer=args.renderer||this.getRenderer(),defaultData={};return defaultData.attributes={href:renderer.resolveUrl(this.attr("href"))},this._super(_.merge(defaultData,args.data),args.placeholder,args.subclass,renderer)}});return Stylesheet}),define("taoQtiItem/qtiCreator/model/Stylesheet",["lodash","taoQtiItem/qtiCreator/model/mixin/editable","taoQtiItem/qtiItem/core/Stylesheet"],function(_,editable,Stylesheet){
"use strict";var methods={};return _.extend(methods,editable),_.extend(methods,{getDefaultAttributes:function(){return{href:"css/tao-user-styles.css",title:"",type:"text/css",media:"all"}}}),Stylesheet.extend(methods)}),define("taoQtiItem/qtiItem/core/ResponseProcessing",["taoQtiItem/qtiItem/core/Element","lodash"],function(Element,_){var ResponseProcessing=Element.extend({qtiClass:"responseProcessing",processingType:"",xml:"",toArray:function(){var arr=this._super();return arr.processingType=this.processingType,arr.xml=this.xml,arr}});return ResponseProcessing}),define("taoQtiItem/qtiCreator/model/ResponseProcessing",["lodash","taoQtiItem/qtiCreator/model/mixin/editable","taoQtiItem/qtiItem/core/ResponseProcessing"],function(_,editable,ResponseProcessing){
"use strict";var methods={};return _.extend(methods,editable),_.extend(methods,{getDefaultAttributes:function(){return{}},setProcessingType:function(processingType){this.processingType!==processingType&&("custom"===this.processingType&&_.each(this.getRootElement().getResponses(),function(r){r.setTemplate("MATCH_CORRECT")}),this.processingType=processingType)}}),ResponseProcessing.extend(methods)}),define("taoQtiItem/qtiItem/core/variables/VariableDeclaration",["taoQtiItem/qtiItem/core/IdentifiedElement"],function(IdentifiedElement){"use strict";var VariableDeclaration=IdentifiedElement.extend({init:function(serial,attributes){this._super(serial,attributes),this.defaultValue=null;
},is:function(qtiClass){return"variableDeclaration"===qtiClass||this._super(qtiClass)},toArray:function(){var arr=this._super();return arr.defaultValue=this.defaultValue,arr},setDefaultValue:function(value){this.defaultValue=value},getDefaultValue:function(){return this.defaultValue}});return VariableDeclaration}),define("taoQtiItem/qtiItem/core/variables/OutcomeDeclaration",["taoQtiItem/qtiItem/core/variables/VariableDeclaration"],function(VariableDeclaration){return VariableDeclaration.extend({qtiClass:"outcomeDeclaration"})}),define("taoQtiItem/qtiCreator/model/variables/OutcomeDeclaration",["lodash","taoQtiItem/qtiCreator/model/mixin/editable","taoQtiItem/qtiItem/core/variables/OutcomeDeclaration"],function(_,editable,OutcomeDeclaration){
"use strict";var methods={};return _.extend(methods,editable),OutcomeDeclaration.extend(methods)}),define("taoQtiItem/qtiItem/core/feedbacks/ModalFeedback",["taoQtiItem/qtiItem/core/IdentifiedElement","taoQtiItem/qtiItem/mixin/Container"],function(IdentifiedElement,Container){var ModalFeedback=IdentifiedElement.extend({qtiClass:"modalFeedback",is:function(qtiClass){return"feedback"===qtiClass||this._super(qtiClass)}});return Container.augment(ModalFeedback),ModalFeedback}),define("taoQtiItem/qtiCreator/model/feedbacks/ModalFeedback",["lodash","taoQtiItem/qtiCreator/model/mixin/editable","taoQtiItem/qtiItem/core/feedbacks/ModalFeedback"],function(_,editable,ModalFeedback){
...
"use strict";return Renderer.build(config.locations,config.name,config.options)}),define("taoQtiItem/qtiItem/helper/response",["lodash"],function(_){"use strict";var _templateNames={MATCH_CORRECT:"http://www.imsglobal.org/question/qti_v2p1/rptemplates/match_correct",MAP_RESPONSE:"http://www.imsglobal.org/question/qti_v2p1/rptemplates/map_response",MAP_RESPONSE_POINT:"http://www.imsglobal.org/question/qti_v2p1/rptemplates/map_response_point",NONE:"no_response_processing"};return{isUsingTemplate:function(response,tpl){return!(!_.isString(tpl)||tpl!==response.template&&_templateNames[tpl]!==response.template)},isValidTemplateName:function(tplName){return!!this.getTemplateUriFromName(tplName);
},getTemplateUriFromName:function(tplName){return _templateNames[tplName]?_templateNames[tplName]:""},getTemplateNameFromUri:function(tplUri){var tplName="";return _.forIn(_templateNames,function(uri,name){if(uri===tplUri)return tplName=name,!1}),tplName}}}),define("taoQtiItem/qtiItem/helper/maxScore",["lodash","lib/gamp/gamp","taoQtiItem/qtiItem/helper/response","taoQtiItem/qtiCreator/model/variables/OutcomeDeclaration"],function(_,gamp,responseHelper,OutcomeDeclaration){"use strict";var _ignoreMinChoice=!0,pairExists=function(collection,pair){return 2===pair.length&&(collection[pair[0]+" "+pair[1]]||collection[pair[1]+" "+pair[0]])};return{setNormalMaximum:function(item){
var normalMaximum,scoreOutcome=item.getOutcomeDeclaration("SCORE");scoreOutcome&&item.responseProcessing&&"templateDriven"===item.responseProcessing.processingType&&(normalMaximum=_.reduce(item.getInteractions(),function(acc,interaction){var interactionMaxScore=interaction.getNormalMaximum();return!!_.isNumber(interactionMaxScore)&&gamp.add(acc,interactionMaxScore)},0),_.isNumber(normalMaximum)?scoreOutcome.attr("normalMaximum",normalMaximum):scoreOutcome.removeAttr("normalMaximum"))},setMaxScore:function(item){var customOutcomes,maxScore,maxScoreOutcome,hasInvalidInteraction=!1,scoreOutcome=item.getOutcomeDeclaration("SCORE");scoreOutcome&&item.responseProcessing&&"templateDriven"===item.responseProcessing.processingType&&(maxScore=_.reduce(item.getInteractions(),function(acc,interaction){
...
}else"MAP_RESPONSE_POINT"===template&&(max=0);return max}}}),define("taoQtiItem/qtiCreator/helper/xmlRenderer",["core/logger","taoQtiItem/qtiXmlRenderer/renderers/Renderer","taoQtiItem/qtiItem/helper/maxScore","taoQtiItem/qtiItem/core/Element"],function(loggerFactory,XmlRenderer,maxScore,Element){"use strict";var logger=loggerFactory("taoQtiItem/qtiCreator/helper/xmlRenderer"),_xmlRenderer=new XmlRenderer({shuffleChoices:!1}).load(),_render=function(element){var xml="";try{element instanceof Element&&(element.is("assessmentItem")&&(maxScore.setNormalMaximum(element),maxScore.setMaxScore(element)),xml=element.render(_xmlRenderer))}catch(e){logger.error(e)}return xml;
};return{render:_render,get:function(){return _xmlRenderer}}}),define("taoQtiItem/qtiItem/helper/simpleParser",["lodash","jquery","taoQtiItem/qtiItem/helper/util","taoQtiItem/qtiItem/core/Loader"],function(_,$,util,Loader){"use strict";function _getElementSelector(qtiClass,ns){return ns?ns+"\\:"+qtiClass+","+qtiClass:qtiClass}function getQtiClassFromXmlDom($node){var qtiClass=$node.prop("tagName").toLowerCase();return qtiClass=qtiClass.replace(/.*:/,""),_qtiClassNames[qtiClass]?_qtiClassNames[qtiClass]:qtiClass}function buildElement($elt){var qtiClass=getQtiClassFromXmlDom($elt),elt={qtiClass:qtiClass,serial:util.buildSerial(qtiClass+"_"),attributes:{}};return $.each($elt[0].attributes,function(){
var attrName;this.specified&&(attrName=_qtiAttributesNames[this.name]||this.name,elt.attributes[attrName]=this.value)}),elt}function buildMath($elt,options){var elt=buildElement($elt);return elt.annotations={},$elt.find(_getElementSelector("annotation",options.ns.math)).each(function(){var $annotation=$(this),encoding=$annotation.attr("encoding");encoding&&(elt.annotations[encoding]=_.unescape($annotation.html())),$annotation.remove()}),elt.mathML=$elt.html(),elt.ns={name:"m",uri:"http://www.w3.org/1998/Math/MathML"},elt}function buildTooltip(targetHtml,contentId,contentHtml){var qtiClass="_tooltip";return{elements:{},qtiClass:qtiClass,serial:util.buildSerial(qtiClass+"_"),
attributes:{"aria-describedby":contentId},content:contentHtml,body:{elements:{},serial:util.buildSerial("container"),body:targetHtml}}}function parseContainer($container,options){var ret={serial:util.buildSerial("_container_"),body:"",elements:{}};return _.each(_parsableElements,function(qtiClass){$container.find(qtiClass).each(function(){var $qtiElement=$(this),element=buildElement($qtiElement,options);ret.elements[element.serial]=element,$qtiElement.replaceWith(_placeholder(element))})}),$container.find(_getElementSelector("math",options.ns.math)).each(function(){var $qtiElement=$(this),element=buildMath($qtiElement,options);ret.elements[element.serial]=element,
$qtiElement.replaceWith(_placeholder(element))}),$container.find(_getElementSelector("include",options.ns.include)).each(function(){var $qtiElement=$(this),element=buildElement($qtiElement,options);ret.elements[element.serial]=element,$qtiElement.replaceWith(_placeholder(element))}),$container.find('[data-role="tooltip-target"]').each(function(){var element,$content,contentHtml,$target=$(this),contentId=$target.attr("aria-describedBy");contentId&&($content=$container.find("#"+contentId),$content.length&&(contentHtml=$content.html(),element=buildTooltip($target.html(),contentId,contentHtml),ret.elements[element.serial]=element,$target.replaceWith(_placeholder(element)),
$content.remove()))}),ret.body=$container.html(),ret}function _placeholder(element){return"{{"+element.serial+"}}"}var parser,_parsableElements=["img","object","printedVariable"],_qtiClassNames={rubricblock:"rubricBlock",printedvariable:"printedVariable"},_qtiAttributesNames={powerform:"powerForm",mappingindicator:"mappingIndicator"},_defaultOptions={ns:{math:"",include:"xi"},loaded:null,model:null};return parser={parse:function(xmlStr,opts){var loader,options=_.merge(_.clone(_defaultOptions),opts||{}),$container=$(xmlStr),element=buildElement($container,options),data=parseContainer($container,options);return _.isUndefined(data.body)||(element.body=data),_.isFunction(options.loaded)&&options.model&&(loader=(new Loader).setClassesLocation(options.model),
loader.loadAndBuildElement(element,options.loaded)),element}}}),define("taoQtiItem/qtiCreator/renderers/config",["lodash","context","taoQtiItem/qtiCommonRenderer/renderers/config","taoItems/assets/manager","taoItems/assets/strategies"],function(_,context,commonRenderConfig,assetManagerFactory,assetStrategies){"use strict";var assetManager=assetManagerFactory([assetStrategies.taomedia,assetStrategies.external,assetStrategies.base64,assetStrategies.baseUrl],{baseUrl:""}),locations=_.defaults({_container:"taoQtiItem/qtiCreator/renderers/Container",_tooltip:"taoQtiItem/qtiCreator/renderers/Tooltip",assessmentItem:"taoQtiItem/qtiCreator/renderers/Item",rubricBlock:"taoQtiItem/qtiCreator/renderers/RubricBlock",
img:"taoQtiItem/qtiCreator/renderers/Img",math:"taoQtiItem/qtiCreator/renderers/Math",object:"taoQtiItem/qtiCreator/renderers/Object",table:"taoQtiItem/qtiCreator/renderers/Table",modalFeedback:"taoQtiItem/qtiCreator/renderers/ModalFeedback",choiceInteraction:"taoQtiItem/qtiCreator/renderers/interactions/ChoiceInteraction",orderInteraction:"taoQtiItem/qtiCreator/renderers/interactions/OrderInteraction",matchInteraction:"taoQtiItem/qtiCreator/renderers/interactions/MatchInteraction",associateInteraction:"taoQtiItem/qtiCreator/renderers/interactions/AssociateInteraction",inlineChoiceInteraction:"taoQtiItem/qtiCreator/renderers/interactions/InlineChoiceInteraction",
textEntryInteraction:"taoQtiItem/qtiCreator/renderers/interactions/TextEntryInteraction",hotspotInteraction:"taoQtiItem/qtiCreator/renderers/interactions/HotspotInteraction",selectPointInteraction:"taoQtiItem/qtiCreator/renderers/interactions/SelectPointInteraction",graphicOrderInteraction:"taoQtiItem/qtiCreator/renderers/interactions/GraphicOrderInteraction",graphicAssociateInteraction:"taoQtiItem/qtiCreator/renderers/interactions/GraphicAssociateInteraction",graphicGapMatchInteraction:"taoQtiItem/qtiCreator/renderers/interactions/GraphicGapMatchInteraction",mediaInteraction:"taoQtiItem/qtiCreator/renderers/interactions/MediaInteraction",uploadInteraction:"taoQtiItem/qtiCreator/renderers/interactions/UploadInteraction",
sliderInteraction:"taoQtiItem/qtiCreator/renderers/interactions/SliderInteraction",extendedTextInteraction:"taoQtiItem/qtiCreator/renderers/interactions/ExtendedTextInteraction","simpleChoice.choiceInteraction":"taoQtiItem/qtiCreator/renderers/choices/SimpleChoice.ChoiceInteraction","simpleChoice.orderInteraction":"taoQtiItem/qtiCreator/renderers/choices/SimpleChoice.OrderInteraction","simpleAssociableChoice.associateInteraction":"taoQtiItem/qtiCreator/renderers/choices/SimpleAssociableChoice.AssociateInteraction","simpleAssociableChoice.matchInteraction":"taoQtiItem/qtiCreator/renderers/choices/SimpleAssociableChoice.MatchInteraction",gapMatchInteraction:"taoQtiItem/qtiCreator/renderers/interactions/GapMatchInteraction",
...
getColUnits:function($elt){var cssClasses=$elt.attr("class");if(!cssClasses)throw new Error("the element has no css class");var colMatch=cssClasses.match(/col-([\d]+)/);if(colMatch&&colMatch.length)return parseInt(colMatch.pop());throw"the element has no col-* class"},setUnitsFromClass:function($el){var units=helpers.getColUnits($el);return $el.attr("data-units",units),units}};return helpers}),define("taoQtiItem/qtiCreator/editor/gridEditor/resizable",["lodash","jquery","taoQtiItem/qtiCreator/editor/gridEditor/config","taoQtiItem/qtiCreator/editor/gridEditor/helper","taoQtiItem/qtiCreator/helper/qtiElements","jqueryui"],function(_,$,config,helper,qtiElements){
...
}function removePlaceholder($editable){$editable.removeClass(placeholderClass)}function getTooltypeFromContainer($editableContainer){var toolbarType="qtiFlow";return $editableContainer.hasClass("widget-blockInteraction")||$editableContainer.hasClass("widget-textBlock")||$editableContainer.hasClass("widget-rubricBlock")?toolbarType="qtiBlock":($editableContainer.hasClass("qti-prompt-container")||$editableContainer.hasClass("widget-hottext"))&&(toolbarType="qtiInline"),toolbarType}function _find($container,dataAttribute){var $collection;return $collection=$container.data(dataAttribute)?$container:$container.find("[data-"+dataAttribute+"=true]")}function _rebuildWidgets(container,$container,options){
var widgets={};return options=options||{},_.each(_.values(container.elements),function(elt){var widget=elt.data("widget"),currentState=widget.getCurrentState().name;widgets[elt.serial]=widget.rebuild({context:$container,ready:function(widget){options.restoreState&&widget.changeState(currentState)}})}),$container.trigger("widgetCreated",[widgets,container]),widgets}function _findWidgetContainer($container,serial){return $container.find(".widget-box[data-serial="+serial+"]")}function _detectWidgetDeletion($container,widgets,editor){var $widget,deleted=[],container=$container.data("qti-container");if(_.each(widgets,function(w){w.element.data("removed")||($widget=_findWidgetContainer($container,w.serial),
$widget.length||deleted.push(w))}),deleted.length){var undoCmd=editor.getCommand("undo"),$messageBox=deletingHelper.createInfoBox(deleted);$messageBox.on("confirm.deleting",function(){_.each(deleted,function(w){w.element.remove(),w.destroy()}),editor.resetUndo()}).on("undo.deleting",function(){editor.undoManager.undo(),_rebuildWidgets(container,$container,{restoreState:!0}),_shieldInnerContent($container,container.data("widget"))}),undoCmd&&undoCmd.on("afterUndo",function(){$messageBox.find("a.undo").click()})}}function addShield($widget){var $shield=$("<button>",{class:"html-editable-shield"});return $widget.attr("contenteditable",!1),$widget.append($shield),
$shield}function _shieldInnerContent($container,containerWidget){$container.find(".widget-box").each(function(){var $widget=$(this);addShield($widget).on("click",function(e){var innerWidget;e.stopPropagation(),innerWidget=$widget.data("widget"),_activateInnerWidget(containerWidget,innerWidget)})})}function _activateInnerWidget(containerWidget,innerWidget){var listenToWidgetCreation;containerWidget&&containerWidget.element&&containerWidget.element.qtiClass?(listenToWidgetCreation=function(){containerWidget.$container.off("widgetCreated").one("widgetCreated",function(e,widgets){var targetWidget=widgets[innerWidget.serial];targetWidget&&_.delay(function(){Element.isA(targetWidget.element,"interaction")?targetWidget.changeState("question"):targetWidget.changeState("active");
},100)})},Element.isA(containerWidget.element,"_container")&&!containerWidget.element.data("stateless")?(listenToWidgetCreation(),containerWidget.changeState("sleep")):Element.isA(containerWidget.element,"interaction")?(listenToWidgetCreation(),containerWidget.changeState("sleep")):Element.isA(containerWidget.element,"choice")?(listenToWidgetCreation(),containerWidget.changeState("question")):Element.isA(containerWidget.element,"table")?(listenToWidgetCreation(),containerWidget.changeState("sleep")):Element.isA(innerWidget.element,"choice")?innerWidget.changeState("choice"):innerWidget.changeState("active")):innerWidget.changeState("active")}function _htmlEncode(encodedStr){
return encodedStr}function _focus(editor){var range;editor.editable()&&editor.editable().$.parentNode&&(editor.focus(),range=editor.createRange(),range.moveToElementEditablePosition(editor.editable(),!0),editor.getSelection().selectRanges([range]))}var editorFactory,_defaults={placeholder:__("some text ..."),shieldInnerContent:!0,passthroughInnerContent:!1,autofocus:!0},placeholderClass="cke-placeholder";return CKEditor.disableAutoInline=!0,editorFactory={hasEditor:function($container){var hasEditor=!1;return _find($container,"html-editable").each(function(){return hasEditor=!!$(this).data("editor")}),hasEditor},buildEditor:function($container,editorOptions){
var buildTasks=[];return _find($container,"html-editable-container").each(function(){var $editableContainer=$(this),$editable=$editableContainer.find("[data-html-editable]");buildTasks.push(new Promise(function(resolve){$editable.attr("contenteditable",!0),_buildEditor($editable,$editableContainer,editorOptions),$editable.on("editorready",resolve)}))}),Promise.all(buildTasks)},destroyEditor:function($container){var destructTasks=[];return _find($container,"html-editable-container").each(function(){var editor,options,$editableContainer=$(this),$editable=$editableContainer.find("[data-html-editable]");$editable.removeAttr("contenteditable"),$editable.data("editor")&&destructTasks.push(new Promise(function(resolve){
editor=$editable.data("editor"),options=$editable.data("editor-options"),_.isFunction(options.change)&&options.change.call(editor,_htmlEncode(editor.getData())),removePlaceholder($editable),editor.on("destroy",function(){$editable.removeData("editor").removeData("editor-options"),$editable.data("qti-container")&&_rebuildWidgets($editable.data("qti-container"),$editable),$editable.trigger("editordestroyed"),resolve()}),editor.focusManager.blur(!0),editor.destroy()}))}),Promise.all(destructTasks)},getData:function($editable){var editor=$editable.data("editor");if(editor)return _htmlEncode(editor.getData());throw new Error("no editor attached to the DOM element");
},setData:function($editable,data){var editor=$editable.data("editor");if(!editor)throw new Error("no editor attached to the DOM element");_.isString(data)&&editor.setData(_.escape(data))},focus:function($editable){_find($editable,"html-editable").each(function(){var editor=$(this).data("editor");editor&&_focus(editor)})}}}),define("taoQtiItem/qtiCreator/editor/containerEditor",["lodash","jquery","core/promise","taoQtiItem/qtiItem/core/Loader","taoQtiItem/qtiCreator/model/Container","taoQtiItem/qtiCreator/model/Item","taoQtiItem/qtiCreator/model/helper/event","taoQtiItem/qtiCreator/model/qtiClasses","taoQtiItem/qtiCreator/helper/commonRenderer","taoQtiItem/qtiCreator/helper/xmlRenderer","taoQtiItem/qtiItem/helper/simpleParser","taoQtiItem/qtiCreator/helper/creatorRenderer","taoQtiItem/qtiCreator/helper/xincludeRenderer","taoQtiItem/qtiCreator/editor/gridEditor/content","taoQtiItem/qtiCreator/editor/ckEditor/htmlEditor"],function(_,$,Promise,Loader,Container,Item,event,allQtiClasses,commonRenderer,xmlRenderer,simpleParser,creatorRenderer,xincludeRenderer,content,htmlEditor){
"use strict";function parser($container){var mathNs="m",data=simpleParser.parse($container.clone(),{ns:{math:mathNs}});if(data.body)return data.body;throw new Error("invalid content for qti container")}function create($container,options){var html,htmls,data,loader;options=_.defaults(options||{},_defaults),options.markup&&(html=options.markup,options.markupSelector&&(htmls=extractHtmlFromMarkup(html,options.markupSelector),html=htmls[0]||""),$container.html(html)),data=parser($container),loader=(new Loader).setClassesLocation(allQtiClasses),loader.loadRequiredClasses(data,function(){var item,containerEditors,renderer,qtiClasses=["img","object","math","include","printedVariable","_container","_tooltip"],container=new Container;
container.data("stateless",!0),$container.data("container",container),item=(new Item).setElement(container),container.setRootElement(item),options.metadata&&_.each(options.metadata,function(value,name){item.data(name,value)}),options.related&&(containerEditors=options.related.data("container-editors")||[],containerEditors.push(container),options.related.data("container-editors",containerEditors)),this.loadContainer(container,data),renderer=creatorRenderer.get(options.resetRenderer,{},options.areaBroker),renderer.load(function(){var baseUrl=this.getOption("baseUrl");container.setRenderer(this),$container.html(container.render()),container.postRender(),_.each(container.getComposingElements(),function(element){
"include"===element.qtiClass&&xincludeRenderer.render(element.data("widget"),baseUrl)}),buildContainer($container),buildEditor($container,container,{placeholder:options.placeholder||void 0,toolbar:options.toolbar||void 0,qtiMedia:options.qtiMedia,highlight:options.highlight,removePlugins:options.removePlugins||"",areaBroker:options.areaBroker,autofocus:options.autofocus||!1}),$container.off("."+_ns).on(event.getList(_ns+event.getNs()+event.getNsModel()).join(" "),_.throttle(function(){var editorContent=container.render(xmlRenderer.get());$container.trigger("containerchange."+_ns,[editorContent]),_.isFunction(options.change)&&options.change(editorContent)},600)),
$container.trigger("editorready.containereditor")},qtiClasses)})}function buildContainer($container){$container.wrapInner($("<div>",{class:"container-editor","data-html-editable":!0}))}function cleanup($container){var container=$container.data("container");return new Promise(function(resolve){container?($(document).off("."+container.serial),commonRenderer.load(["img","object","math","include","_container","printedVariable","_tooltip"],function(){$container.html(container.render(this)),resolve()}),$container.removeData("container")):resolve()})}function createFakeWidget($editableContainer,container,options){var widget={$container:$editableContainer,element:container,
changeState:_.noop,getAreaBroker:function(){return options.areaBroker}};return container.data("widget",widget),widget}function buildEditor($editableContainer,container,options){$editableContainer.attr("data-html-editable-container",!0),htmlEditor.hasEditor($editableContainer)||htmlEditor.buildEditor($editableContainer,_.defaults(options||{},{shieldInnerContent:!1,passthroughInnerContent:!1,change:content.getChangeCallback(container),data:{widget:createFakeWidget($editableContainer,container,options),container:container}}))}function destroy($editableContainer){return htmlEditor.destroyEditor($editableContainer).then(function(){return $editableContainer.removeAttr("data-html-editable-container"),
cleanup($editableContainer)})}function extractHtmlFromMarkup(markupStr,selector){var $found=$("<div>").html(markupStr).find(selector),ret=[];return $found.each(function(){ret.push($(this).html())}),ret}var _ns="containereditor",_defaults={change:_.noop,markup:"",markupSelector:"",qtiMedia:!1};return event.initElementToWidgetListeners(),{create:create,destroy:destroy}}),define("taoQtiTest/controller/creator/qtiContentCreator",["lodash","jquery","lib/uuid","taoQtiItem/qtiCreator/helper/commonRenderer","taoQtiItem/qtiCreator/editor/containerEditor"],function(_,$,uuid,qtiCommonRenderer,containerEditor){"use strict";return{create:function(creatorContext,$container,options){
...
$(".itemref",$section).each(function(){var $itemRef=$(this),index=$itemRef.data("bind-index");sectionModel.sectionParts[index]||(sectionModel.sectionParts[index]={}),itemRefView.setUp(creatorContext,sectionModel.sectionParts[index],sectionModel,partModel,$itemRef),$itemRef.find(".title").text(config.labels[uri.encode($itemRef.data("uri"))])})}function acceptItemRefs(){var $itemsPanel=$(".test-creator-items .item-selection");$itemsPanel.on("itemselect.creator",function(e,selection){var $placeholder=$(".itemref-placeholder",$section),$placeholders=$(".itemref-placeholder");_.size(selection)>0?$placeholder.show().off("click").on("click",function(){var categories,defaultItemData={};
sectionModel.itemSessionControl&&!_.isUndefined(sectionModel.itemSessionControl.maxAttempts)&&(defaultItemData.itemSessionControl=_.clone(sectionModel.itemSessionControl)),categories=sectionCategory.getCategories(sectionModel),defaultItemData.categories=_.clone(categories.propagated)||[],_.forEach(selection,function(item){var itemData=_.defaults({href:item.uri,label:item.label,"qti-type":"assessmentItemRef"},defaultItemData);_.isArray(item.categories)&&(itemData.categories=item.categories.concat(itemData.categories)),addItemRef($(".itemrefs",$section),null,itemData)}),$itemsPanel.trigger("itemselected.creator"),$placeholders.hide().off("click")}):$placeholders.hide().off("click");
}),$(document).off("add.binder","#"+$section.attr("id")+" .itemrefs").on("add.binder","#"+$section.attr("id")+" .itemrefs",function(e,$itemRef){var index,itemRefModel;"binder"===e.namespace&&$itemRef.hasClass("itemref")&&(index=$itemRef.data("bind-index"),itemRefModel=sectionModel.sectionParts[index],itemRefView.setUp(creatorContext,itemRefModel,sectionModel,partModel,$itemRef),modelOverseer.trigger("item-add",itemRefModel))})}function addItemRef($refList,index,itemData){var $itemRef,$items=$refList.children("li");index=index||$items.length,itemData.identifier=qtiTestHelper.getAvailableIdentifier(modelOverseer.getModel(),"assessmentItemRef","item"),itemData.index=index+1,
$itemRef=$(templates.itemref(itemData)),index>0?$itemRef.insertAfter($items.eq(index-1)):$itemRef.appendTo($refList),$refList.trigger("add",[$itemRef,itemData])}function rubricBlocks(){sectionModel.rubricBlocks||(sectionModel.rubricBlocks=[]),$(".rubricblock",$section).each(function(){var $rubricBlock=$(this),index=$rubricBlock.data("bind-index");sectionModel.rubricBlocks[index]||(sectionModel.rubricBlocks[index]={}),rubricBlockView.setUp(creatorContext,sectionModel.rubricBlocks[index],$rubricBlock)}),sectionModel.rubricBlocks.length>0&&$(".rub-toggler",$section).trigger("click")}function addRubricBlock(){$(".rublock-adder",$section).adder({target:$(".rubricblocks",$section),
