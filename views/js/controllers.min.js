...
}),$("#qti-comment-cancel").click(function(){TestRunner.closeComment()}),$("#qti-comment-send").click(function(){TestRunner.storeComment()}),$("#qti-comment > textarea").click(function(){TestRunner.emptyComment()}),$(window).bind("resize",function(){TestRunner.adjustFrame(),$("#qti-test-title, #qti-test-position").badonkatrunc()}),$(document).bind("loading",function(){iframeNotifier.parent("loading")}),$(document).bind("unloading",function(){iframeNotifier.parent("unloading")}),iframeNotifier.parent("serviceready")}}});
