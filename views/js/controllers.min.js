...
this.disableGui(),$controls.$itemFrame.hide(),$controls.$rubricBlocks.hide(),$controls.$timerWrapper.hide(),"function"==typeof callback&&setTimeout(callback,waitingTime)},afterTransition:function(){this.enableGui(),iframeNotifier.parent("unloading")},jump:function(position){var self=this,action="jump",params={position:position};this.disableGui(),this.isJumpOutOfSection(position)&&this.isCurrentItemActive()&&this.isTimedSection()?this.exitTimedSection(action,params):this.itemServiceApi.kill(function(){self.actionCall(action,null,params)})},markForReview:function(flag,position){var self=this;iframeNotifier.parent("loading"),this.disableGui(),this.itemServiceApi.kill(function(){
$.ajax({url:self.testContext.markForReviewUrl,cache:!1,async:!0,type:"POST",dataType:"json",data:{flag:flag,position:position},success:function(testContext){self.setTestContext(testContext),self.updateTestReview(),self.itemServiceApi.connect($controls.$itemFrame[0]),self.enableGui(),iframeNotifier.parent("unloading")}})})},moveForward:function(){var self=this,action="moveForward";this.disableGui(),this.testContext.numberItemsSection-this.testContext.itemPositionSection-1==0&&this.isCurrentItemActive()?this.isTimedSection()?this.exitTimedSection(action):this.exitSection(action):this.itemServiceApi.kill(function(){self.actionCall(action)})},moveBackward:function(){
