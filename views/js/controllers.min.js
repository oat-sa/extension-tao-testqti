...
description:__("enable calculator")},{name:"x-tao-option-areaMasking",description:__("enable area masking tool")},{name:"x-tao-option-highlighter",description:__("enable highlighter tool")},{name:"x-tao-option-line-reader",description:__("enable line reader tool")},{name:"x-tao-option-magnifier",description:__("enable magnifier tool")},{name:"x-tao-option-eliminator",description:__("enable answer eliminator tool")},{name:"x-tao-itemusage-informational",description:__("describe the item as informational")}]}var _ns=".sectionCategory";return{isValidSectionModel:isValidSectionModel,setCategories:setCategories,getCategories:getCategories,addCategories:addCategories,
removeCategories:removeCategories,getTaoOptionCategories:getTaoOptionCategories}}),define("taoQtiTest/controller/creator/helpers/qtiTest",["lodash","i18n","taoQtiTest/controller/creator/helpers/outcome","taoQtiTest/controller/creator/helpers/qtiElement"],function(_,__,outcomeHelper,qtiElementHelper){"use strict";var qtiTestHelper={extractIdentifiers:function(obj){var self=this,identifiers=[];return _.has(obj,"identifier")&&(identifiers=identifiers.concat(obj.identifier.toLowerCase())),_.flatten(_.forEach(obj,function(value){identifiers=identifiers.concat("object"==typeof value?self.extractIdentifiers(value):[])}),!0),identifiers},getIdentifier:function(qtiType,lockedIdentifiers){
var suggestion,index=1,glue="-";do suggestion=qtiType+glue+index++;while(_.contains(lockedIdentifiers,suggestion.toLowerCase()));return lockedIdentifiers.push(suggestion.toLowerCase()),suggestion},idFormatValidator:function(){var qtiIdPattern=/^[_a-zA-Z]{1}[a-zA-Z0-9\-._]{0,31}$/i;return{name:"idFormat",message:__("is not a valid identifier (alphanum, underscore, dash and dots)"),validate:function(value,callback){"function"==typeof callback&&callback(qtiIdPattern.test(value))}}},testidFormatValidator:function(){var qtiTestIdPattern=/^\S+$/;return{name:"testIdFormat",message:__("is not a valid identifier (everything except spaces)"),validate:function(value,callback){
