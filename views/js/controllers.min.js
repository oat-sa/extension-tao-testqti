...
}function removeCategories(model,categories){isValidSectionModel(model)?_.each(model.sectionParts,function(itemRef){"assessmentItemRef"===itemRef["qti-type"]&&_.isArray(itemRef.categories)&&(itemRef.categories=_.difference(itemRef.categories,categories))}):errorHandler["throw"](_ns,"invalid tool config format")}function getTaoOptionCategories(){return[{name:"x-tao-option-endTestWarning",description:__("displays a warning before the user finishes the test")},{name:"x-tao-option-nextPartWarning",description:__("displays a warning before the user finishes the part")},{name:"x-tao-option-nextSectionWarning",description:__("displays a next section button that warns the user that they will not be able to return to the section")
},{name:"x-tao-option-nextSection",description:__("displays a next section button")},{name:"x-tao-option-unansweredWarning",description:__("displays a warning before the user finishes the part, only if there are unanswered/marked for review items")},{name:"x-tao-option-noExitTimedSectionWarning",description:__("disable the warning automatically displayed upon exiting a timed section")},{name:"x-tao-option-exit",description:__("displays an exit button")},{name:"x-tao-option-markReview",description:__("displays a mark for review button. This option requires requires the x-tao-option-reviewScreen option")},{name:"x-tao-option-reviewScreen",description:__("displays the review screen / navigator")
},{name:"x-tao-option-calculator",description:__("enable calculator")},{name:"x-tao-option-answerMasking",description:__("enable answer masking tool")},{name:"x-tao-option-areaMasking",description:__("enable area masking tool")},{name:"x-tao-option-highlighter",description:__("enable highlighter tool")},{name:"x-tao-option-line-reader",description:__("enable line reader tool")},{name:"x-tao-option-magnifier",description:__("enable magnifier tool")},{name:"x-tao-option-eliminator",description:__("enable answer eliminator tool")},{name:"x-tao-itemusage-informational",description:__("describe the item as informational")}]}var _ns=".sectionCategory";return{isValidSectionModel:isValidSectionModel,
