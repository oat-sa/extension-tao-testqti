...
class AdaptiveSectionInjectionException extends CatException
{
     ...
     * @param array An array of string containing the invalid items identifiers.
     ...
     */
    public function __construct($message, $invalidItemIdentifiers, $code = 0, \Exception $previous = null)
    {
