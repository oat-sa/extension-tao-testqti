...
class CatService extends ConfigurableService
{
    ...
    {
        $data = $privateCompilationDirectory->getFile("adaptive-assessment-item-ref-${identifier}")->read();
    ...
    public function getAssessmentItemRefsByPlaceholder(\tao_models_classes_service_StorageDirectory $privateCompilationDirectory, AssessmentItemRef $placeholder)
    {
        ...
        $data = $privateCompilationDirectory->getFile("adaptive-assessment-section-${adaptiveSectionId}")->read();

        return unserialize($data)->getComponentsByClassName('assessmentItemRef')->getArrayCopy();
    }
