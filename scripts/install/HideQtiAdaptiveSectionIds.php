...
class HideQtiAdaptiveSectionIds extends InstallAction
{
    public function __invoke($params)
    {
        ...
        $adaptiveSectionIdsProperty->removePropertyValues($widgetProperty);

        return new Report(Report::TYPE_SUCCESS, 'QTI CAT Adaptive Section IDs are now hidden in the GUI.');
    }
}
