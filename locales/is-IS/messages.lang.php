...
<<<<<<< Updated upstream
=======
$GLOBALS['__l10n']["\n            Create items, manage item and test banks, organize cohorts and deliveries, prepare reports, set up workflows."]="\n                                            Búa til atriði, hafa umsjón með atriðum og prófabönkum, skipuleggja flokka og skil, unidrbúa skýrslur, stilla upp verkefnaflæði.";
...
$GLOBALS['__l10n']["%s Locked', get_data('topclass-label"]="%s Læst', get_data('topclass-label";
...
$GLOBALS['__l10n']["Hi, %s<br>You indicated that you have forgotten your TAO password.\", get_data('user_name"]="Sæl/Sæll, %s<br>Þú gafst til kynna að þú hefðir gleymt TAO aðgangsorðinu þínu.\", get_data('user_name";
...
$GLOBALS['__l10n']["is not a valid identifier (alphanum, underscore, dash and dots.)"]="er ekki gilt heiti (tölur, undirstrik, bandstrik og punktar.)";
...
$GLOBALS['__l10n']["Maximum time limit reached for item \"%s\"."]="Hámarkstíma náð fyrir atriði \"%\".";
...
$GLOBALS['__l10n']["Releasing the lock might cause the work in progress by %s to be lost.', get_data('ownerHtml"]="Með því að taka lásinn af gæti verkefni í vinnslu að %s tapast.', get_data('ownerHtml";
...
$GLOBALS['__l10n']["Skip & End Test"]="Sleppa og ljúka prófi";
$GLOBALS['__l10n']["Skip the current task and give an empty response."]="Sleppa núverandi verkefni og skila auðu.";
$GLOBALS['__l10n']["Skip the current task, give an empty response and head for the end of the test."]="Sleppa núverandi verkefni, skila auðu og fara í lok prófs.";
$GLOBALS['__l10n']["Submission"]="Sending/Skil";
$GLOBALS['__l10n']["Submit your responses and head for the end of the test."]="Sendu svör þín og farðu í lok prófs.";
$GLOBALS['__l10n']["Submit your responses and head for the next item."]="Sendu svör þín og farðu í næsta atriði.";
$GLOBALS['__l10n']["Submit your responses and head for the previous item."]="Sendu svör þín og farðu í næsta atriði á undan.";
...
$GLOBALS['__l10n']["Test completed at %d%%"]="Prófi lokið %d%%";
...
$GLOBALS['__l10n']["This %s is currently checked out', get_data('topclass-label"]="Þessa %s er búið að skrá út', get_data('topclass-label";
...
$GLOBALS['__l10n']["Uninstall of %s failed', \$this->getRequestParameter('id"]="Mistókst að fjarlægja %s', \$this->getRequestParameter('id";
$GLOBALS['__l10n']["Uninstalled %s', \$this->getRequestParameter('id"]="Búið að fjarlægja %s', \$this->getRequestParameter('id";
...
$GLOBALS['__l10n']["Your comment..."]="Athugasemdir þínar...";
