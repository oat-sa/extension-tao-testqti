...
$GLOBALS['__l10n']["A QTI Test must contain at least one QTI Item to be compiled. None found."]="沒有找到任何題目。一個QTI考試必須有至少一個QTI項目才能進行編譯。";
...
$GLOBALS['__l10n']["Add a zip file containing QTI tests and items"]="新增一個有包含QTI考試和QTI題目的ZIP檔案";
$GLOBALS['__l10n']["Add an RDF/XML file"]="新增 RDF/XML 檔案";
$GLOBALS['__l10n']["Add Consumer"]="加入消費者";
$GLOBALS['__l10n']["Add file(s)"]="新增檔案";
$GLOBALS['__l10n']["Add selected item(s) here."]="在此處新增所選的題目。";
...
$GLOBALS['__l10n']["An item involved in the test cannot be read or is not QTI compliant."]="一個牽涉考試使用的題目無法被讀取或不兼容QTI。";
$GLOBALS['__l10n']["An item involved in the test cannot be written."]="一個在考試的題目不能被寫入。";
...
$GLOBALS['__l10n']["Controls the maximum number of attempts allowed. 0 means unlimited."]="允許最大的使用次數. 輸入0為無限制。";
...
$GLOBALS['__l10n']["If the candidate can skip the item, without submitting a response."]="考生是否可以不提交回應而跳過題目。";
...
$GLOBALS['__l10n']["Item Reference Properties"]="題目參考屬性";
$GLOBALS['__l10n']["Item Session Control"]="題目時域控制";
$GLOBALS['__l10n']["Items"]="題目";
$GLOBALS['__l10n']["Items can optionally be assigned to one or more categories."]="題目可以選擇性的被分配到一個或多個類別。";
$GLOBALS['__l10n']["Items Compilation"]="題目編譯";
...
$GLOBALS['__l10n']["Manage Rubric Blocks"]="管理指導語區塊";
...
$GLOBALS['__l10n']["New Rubric Block"]="新指導語區塊";
...
$GLOBALS['__l10n']["No more attempts allowed for item \"%s\"."]="題目\"%s\"已經無剩餘的使用次數。";
$GLOBALS['__l10n']["No Preview available"]="沒有可用的預覽";
$GLOBALS['__l10n']["No preview available"]="沒有可用的預覽";
$GLOBALS['__l10n']["No reference to any IMS QTI Item found."]="沒有找到任何對照 IMS QTI 的題目。";
...
$GLOBALS['__l10n']["One or more dependent IMS QTI Items could not be imported."]="有一個或多個獨立 IMS QTI 題目無法被匯入。";
...
$GLOBALS['__l10n']["Remove Rubric Block"]="移除指導語區塊";
...
$GLOBALS['__l10n']["Rubric Block"]="指導語區塊";
$GLOBALS['__l10n']["Rubric Block Properties"]="指導語區塊屬性";
$GLOBALS['__l10n']["Rubric Blocks"]="指導語區塊";
...
$GLOBALS['__l10n']["Select Items"]="選取題目";
...
$GLOBALS['__l10n']["Submit your responses and head for the next item."]="提交你的回应和前往下一題目。";
$GLOBALS['__l10n']["Submit your responses and head for the previous item."]="提交你的回应和前往上一个題目。";
...
$GLOBALS['__l10n']["The identifier of the item reference."]="該題目引用的標識符。";
...
$GLOBALS['__l10n']["The navigation mode determines the general paths that the candidate may take. A linear mode restricts the candidate to attempt each item in turn. Non Linear removes this restriction."]="導航模式決定了報考者可採取的一般途徑。線性模式限制了報考者依次嘗試每一個題目。非線性模式移除了這個限制。";
...
$GLOBALS['__l10n']["The QTI Test '%s' to be compiled must contain at least 1 QTI Item. None found."]="該QTI考試必須有至少1個QTI題目'%s' 才能進行編譯。沒有找到。";
$GLOBALS['__l10n']["The QTI test could not be retrieved correctly."]="該QTI考試不能被正確檢索。";
$GLOBALS['__l10n']["The QTI Test XML or one of its dependencies is malformed or empty."]="該QTI XML考試或它的一個相依性索引是不正常的或空的。";
$GLOBALS['__l10n']["The QTI-XML test could not be written correctly."]="該QTI-XML考試未能被正確寫入。";
...
$GLOBALS['__l10n']["The test part identifier."]="考試部分的標識符。";
$GLOBALS['__l10n']["The test title."]="考試標題。";
...
$GLOBALS['__l10n']["Whether a candidate's response that is beyond the maximum duration of the item should still be accepted."]="考生的回應如果超出題目時限，項目是否還被接受。";
...
$GLOBALS['__l10n']["Who can view the rubric block during the delivery."]="遞送時, 誰可以瀏覽指導語區塊。";
