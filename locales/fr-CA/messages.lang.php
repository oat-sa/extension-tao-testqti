...
$GLOBALS['__l10n']["%s - item %p/%c"]="%s - élément %p/%c";
...
$GLOBALS['__l10n']["After you complete the section it would be impossible to return to this section to make changes. Are you sure you want to end the section?"]="Après avoir complété la section, il ne sera pas possible d'y retourner pour apporter des modifications. Êtes-vous certain de vouloir terminer la section?";
...
$GLOBALS['__l10n']["An error occurs, please contact your administrator"]="Une erreur s'est produite, veuillez communiquer avec votre administrateur";
$GLOBALS['__l10n']["An item involved in the test cannot be read or is not QTI compliant."]="Un item impliqué dans le test ne peut être lu ou n'est pas conforme à QTI.";
$GLOBALS['__l10n']["An item involved in the test cannot be written."]="Un item impliqué dans le test ne peut être écrit.";
$GLOBALS['__l10n']["An unknown error occured while compiling QTI test '%s'."]="Une erreur inconnue s'est produite pendant la compilation du QTI test '%s'. ";
$GLOBALS['__l10n']["Answered"]="Répondu";
...
$GLOBALS['__l10n']["Are you sure you want to end the test?"]="Êtes-vous certain de vouloir terminer le test?";
...
$GLOBALS['__l10n']["Candidate"]="Candidat";
...
$GLOBALS['__l10n']["Collapse the review panel"]="Fermer le panneau de révision";
$GLOBALS['__l10n']["Column"]="Colonne";
$GLOBALS['__l10n']["Comment"]="Commentaire";
$GLOBALS['__l10n']["Commit message : "]="Message de modification : ";
$GLOBALS['__l10n']["Completed items"]="Éléments complétés";
...
$GLOBALS['__l10n']["Do not mark the current item for later review"]="Ne pas marquer l'élément actuel pour une révision ultérieure";
...
$GLOBALS['__l10n']["Expand the review panel"]="Agrandir le panneau de révision";
...
$GLOBALS['__l10n']["Flagged"]="Signalé";
...
$GLOBALS['__l10n']["Hide review"]="Masquer révision";
$GLOBALS['__l10n']["Hide the review screen"]="Masquer l'écran de révision";
...
$GLOBALS['__l10n']["In this part of the test navigation is not allowed."]="Dans cette partie du test, la navigation n'est pas permise.";
$GLOBALS['__l10n']["Inclusive (AND)"]="Inclusif (ET)";
$GLOBALS['__l10n']["Individual"]="Individuel";
...
$GLOBALS['__l10n']["Item \"%s\" is completed."]="L'élément \"%s\" est terminé.";
$GLOBALS['__l10n']["Item %d of %d"]="Élément %d de %d";
$GLOBALS['__l10n']["Items"]="Éléments";
$GLOBALS['__l10n']["Items marked for later review"]="Éléments marqués pour révision ultérieure";
$GLOBALS['__l10n']["Label"]="Libellé";
$GLOBALS['__l10n']["Label *"]="Etiquette *";
$GLOBALS['__l10n']["Language"]="Langue";
$GLOBALS['__l10n']["Last Name"]="Nom";
$GLOBALS['__l10n']["Leave a comment"]="Laissez un commentaire";
...
$GLOBALS['__l10n']["Mark for review"]="Marquer pour révision";
$GLOBALS['__l10n']["Mark the current item for later review"]="Marquer l'élément en cours pour une révision ultérieure";
$GLOBALS['__l10n']["Maximum duration for the all test."]="Durée maximale pour l'ensemble du test.";
$GLOBALS['__l10n']["Maximum duration for this item."]="Durée maximale pour cet élément.";
$GLOBALS['__l10n']["Maximum duration for this section."]="Durée maximale pour cette section.";
$GLOBALS['__l10n']["Maximum duration for this test part."]="Durée maximale pour cette partie de test.";
$GLOBALS['__l10n']["Minimum Duration"]="Durée minimale";
$GLOBALS['__l10n']["Minimum duration for the test."]="Durée minimale pour le test.";
$GLOBALS['__l10n']["Minimum duration for this item."]="Durée minimale pour cet élément.";
$GLOBALS['__l10n']["Minimum duration for this section."]="Durée minimale pour cette section.";
$GLOBALS['__l10n']["Minimum duration for this test part."]="Durée minimale pour cette partie de test.";
...
$GLOBALS['__l10n']["Next"]="Prochain";
$GLOBALS['__l10n']["Next Section"]="Prochaine Section";
...
$GLOBALS['__l10n']["No more attempts allowed for item \"%s\"."]="Une tentative sur l'élément \"%s\" n'est plus permise.";
$GLOBALS['__l10n']["No Preview available"]="Aucun aperçu disponible";
$GLOBALS['__l10n']["No preview available"]="Aucun aperçu disponible";
$GLOBALS['__l10n']["No results found"]="Aucun résultat trouvé";
$GLOBALS['__l10n']["Non Linear"]="Non linéaire";
...
$GLOBALS['__l10n']["Only display the items marked for review"]="Afficher seulement les éléments marqués pour révision";
$GLOBALS['__l10n']["Only display the unanswered items"]="Afficher seulement les éléments non répondus";
...
$GLOBALS['__l10n']["Ordering"]="Commander";
$GLOBALS['__l10n']["Page"]="Page";
$GLOBALS['__l10n']["Part %d"]="Partie %d";
...
$GLOBALS['__l10n']["Proctor"]="Surveillance";
...
$GLOBALS['__l10n']["Required"]="Champs obligatoires";
$GLOBALS['__l10n']["Required field"]="Champs requis";
...
$GLOBALS['__l10n']["Response Required."]="Réponse Requise.";
$GLOBALS['__l10n']["Responsive mode"]="Mode réactif";
$GLOBALS['__l10n']["Review"]="Révision";
...
$GLOBALS['__l10n']["Show review"]="Montrer de révision";
$GLOBALS['__l10n']["Show Solution"]="Montrer la solution";
$GLOBALS['__l10n']["Show the review screen"]="Montrer l'écran de révision";
$GLOBALS['__l10n']["Show/Hide the review screen"]="Montrer/Masquer l'écran de révision";
$GLOBALS['__l10n']["Shuffle"]="Mélanger";
$GLOBALS['__l10n']["Simple Mode"]="Mode simple";
$GLOBALS['__l10n']["Size"]="Taille";
$GLOBALS['__l10n']["Skip"]="Sauter";
$GLOBALS['__l10n']["Skip  and go to the next item"]="Passer et passer à l'élément suivant";
$GLOBALS['__l10n']["Skip &amp; End Test"]="Sauter &amp; Terminer le Test";
$GLOBALS['__l10n']["Skip and end test"]="Test de saut et fin";
$GLOBALS['__l10n']["Skip and go to the end of the test"]="Passer et aller à la fin du test";
$GLOBALS['__l10n']["Skip to the end of the test"]="Sauter à la fin du test";
$GLOBALS['__l10n']["Skip to the next item"]="Sauter au prochain élément";
$GLOBALS['__l10n']["Skip to the next section"]="Sauter à la prochaine section";
$GLOBALS['__l10n']["Start Test-part"]="Commencer la partie du test";
$GLOBALS['__l10n']["Submission"]="Envoyer";
$GLOBALS['__l10n']["Submit and go to the end of the test"]="Envoyer et aller à la fin du test";
$GLOBALS['__l10n']["Submit and go to the next item"]="Envoyer et aller au prochain élément";
$GLOBALS['__l10n']["Submit and go to the previous item"]="Envoyer et aller à l'élément antérieur";
...
$GLOBALS['__l10n']["Test status"]="Statut du test";
...
$GLOBALS['__l10n']["The QTI test could not be retrieved correctly."]="Le test QTI n'a pu être récupéré correctement.";
$GLOBALS['__l10n']["The QTI-XML test could not be written correctly."]="Le test QTI-XML n'a pu être écrit correctement.";
$GLOBALS['__l10n']["The test has been closed/suspended!"]="Le test a été fermé / suspendu!";
...
$GLOBALS['__l10n']["This test has been suspended"]="Ce test a été suspendu";
$GLOBALS['__l10n']["This test has been terminated"]="Ce test a pris fin";
$GLOBALS['__l10n']["Time limit reached for item \"%s\"."]="Limite de temps atteinte pour l'élément \"%s\".";
$GLOBALS['__l10n']["Time limit reached, this part of the test has ended."]="Limite de temps atteinte, cette partie du test s'est terminée.";
...
$GLOBALS['__l10n']["Unanswered"]="Non répondu";
$GLOBALS['__l10n']["Unanswered items"]="Éléments non répondus";
...
$GLOBALS['__l10n']["Unknown error."]="Erreur inconnue.";
$GLOBALS['__l10n']["Unmark for review"]="Démarquer pour révision";
$GLOBALS['__l10n']["Upload"]="Téléverser";
$GLOBALS['__l10n']["Upload a new content"]="Téléverser un nouveau contenu";
$GLOBALS['__l10n']["Upload a QTI 2.1 Test Package File"]="Envoyer un fichier paquet de test QTI 2.1";
...
$GLOBALS['__l10n']["Viewed"]="Vu";
$GLOBALS['__l10n']["Viewed items"]="Éléments vus";
$GLOBALS['__l10n']["Views"]="Vues";
$GLOBALS['__l10n']["Visible"]="Visible";
$GLOBALS['__l10n']["Warning – You have %s remaining to complete the test."]="Avertissement – Il vous reste %s pour compléter le test.";
$GLOBALS['__l10n']["Warning – You have %s remaining to complete this item."]="Avertissement - Vous avez %s restant pour compléter cet élément.";
$GLOBALS['__l10n']["Warning – You have %s remaining to complete this section."]="Avertissement - Vous avez %s restant pour compléter cette section.";
$GLOBALS['__l10n']["Warning – You have %s remaining to complete this test part."]="Avertissement - Vous avez %s restant pour compléter cette partie de test.";
...
$GLOBALS['__l10n']["You cannot continue with this question unanswered."]="VVous devez répondre à cette question pour poursuivre.";
...
$GLOBALS['__l10n']["You have %s item(s) marked for review."]="Vous avez %s élément(s) marqués pour révision.";
$GLOBALS['__l10n']["You have %s unanswered question(s) and have %s item(s) marked for review."]="Vous avez %s question(s) non répondues et avez %s élément(s) marqués pour révision.";
$GLOBALS['__l10n']["You have %s unanswered question(s)."]="Vous avez %s question(s) non répondues.";
