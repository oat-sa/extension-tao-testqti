...
final class ExitTestCommand implements ItemContextAwareInterface, NavigationContextAwareInterface, ToolsStateAwareInterface
{
    ...
    public function __construct(QtiRunnerServiceContext $serviceContext)
    {
