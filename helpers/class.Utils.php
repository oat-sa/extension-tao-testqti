...
class taoQtiTest_helpers_Utils {
    ...
    static public function buildAssessmentItemRefsTestMap(XmlDocument $test, taoQtiTest_models_classes_ManifestParser $manifestParser, $basePath) {
        ...
        $itemResources = $manifestParser->getResources(array('imsqti_item_xmlv2p1', 'imsqti_apipitem_xmlv2p1', 'imsqti_apipitem_xmlv2p2'), taoQtiTest_models_classes_ManifestParser::FILTER_RESOURCE_TYPE);
